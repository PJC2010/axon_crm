// Analytics event helpers — Google Analytics 4.
//
// The GA tag is mounted in app/layout.tsx, gated on
 ...
 *  "value delivered before the ask" moment. Fires on a successful sample;
 *  see components/ZipSampleWidget. */
